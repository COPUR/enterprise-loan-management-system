# Hexagonal HLD Compliance Checklist (Open Finance UC01-UC15)
...
- `docs/architecture/open-finance/use-cases/hld/OPEN_FINANCE_GUARDRAILS_STANDARDS_CATALOG.md`
...
- [ ] Use-case orchestration is in application layer and depends only on domain ports.
...
| --- | --- | --- | --- | --- | --- |
| `UC01_Consent_Management_System.md` | Clear | Strong | Strong | High | Compliant |
| `UC02_Account_Information_Service.md` | Clear | Strong | Read cache defined | High | Compliant |
| `UC003_Confirmation_of_Payee_HLD.md` | Clear | Strong | Read cache defined | High | Compliant |
| `UC006_Payments_HLD.md` | Clear | Strong | Strong write idempotency | High | Compliant |
| `UC05_UC08_Corporate_Treasury_Services.md` | Clear | Strong | Batch idempotency explicit | High | Compliant |
| `UC09_UC10_Insurance_Services.md` | Clear | Strong | Quote/cache semantics explicit | High | Compliant |
| `UC11_FX_Services.md` | Clear | Strong | Quote/deal idempotency explicit | High | Compliant |
| `UC001_UC015_Open_Finance_Use_Cases_Overview.md` | Conceptual (cross-UC) | Strong | Baseline stated | Medium | Compliant |

## Implementation Follow-up (Current)
- UC12 implementation completed using this checklist:
