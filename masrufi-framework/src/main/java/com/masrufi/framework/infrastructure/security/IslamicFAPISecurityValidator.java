...
import com.bank.infrastructure.security.FAPISecurityException;
 ...
 * 
 * Extends the enterprise FAPISecurityValidator to provide Islamic finance-specific
 ...
 */
@Component
public class IslamicFAPISecurityValidator extends FAPISecurityValidator {
    ...
    private void validateHalalAssets(Object transaction) {
        ...
        if (HARAM_ASSETS.matcher(transactionJson).find()) {
            throw new FAPISecurityException("Haram (forbidden) assets detected in transaction", "haram_asset_violation");
        }
    ...
    private void validateMurabahaTransaction(Object transaction) {
        ...
        if (profitMargin == null) {
            throw new FAPISecurityException("Profit margin required for Murabaha transaction", "murabaha_validation_error");
        }
