...
import com.bank.infrastructure.analytics.IslamicBankingAnalyticsService;
...
public class MasrufiAnalyticsConfiguration {
    ...
    public IslamicBankingAnalyticsService islamicBankingAnalyticsService(RedisTemplate<String, String> redisTemplate) {
