package com.enterprise.openfinance.businessfinancialdata.infrastructure.security;

import com.enterprise.openfinance.businessfinancialdata.infrastructure.config.CorporateSecurityProperties;
...
public class DpopProofValidationFilter extends OncePerRequestFilter {
    ...
    private final CorporateSecurityProperties securityProperties;
    private final Clock clock;

    public DpopProofValidationFilter(CorporateSecurityProperties securityProperties, Clock corporateTreasuryClock) {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        return !request.getRequestURI().startsWith("/open-finance/v1/corporate/");
    }
