...
import com.enterprise.openfinance.businessfinancialdata.infrastructure.security.DpopAwareBearerTokenResolver;
import com.enterprise.openfinance.businessfinancialdata.infrastructure.security.DpopProofValidationFilter;
...
@EnableConfigurationProperties(CorporateSecurityProperties.class)
public class CorporateSecurityConfiguration {

    @Bean
    public SecurityFilterChain corporateSecurityFilterChain(HttpSecurity http,
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.GET, "/open-finance/v1/corporate/accounts").hasAuthority("SCOPE_read_accounts")
                        .requestMatchers(HttpMethod.GET, "/open-finance/v1/corporate/accounts/*/balances").hasAuthority("SCOPE_read_balances")
                        .requestMatchers(HttpMethod.GET, "/open-finance/v1/corporate/transactions").hasAuthority("SCOPE_read_transactions")
    ...
    @Bean
    public JwtDecoder jwtDecoder(CorporateSecurityProperties properties) {
