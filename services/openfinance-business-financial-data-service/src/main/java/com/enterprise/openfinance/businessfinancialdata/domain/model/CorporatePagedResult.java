...
public record CorporatePagedResult<T>(
        List<T> items,
        int page,
        int pageSize,
        long totalRecords,
    ...
    public CorporatePagedResult<T> withCacheHit(boolean value) {
        return new CorporatePagedResult<>(items, page, pageSize, totalRecords, value);
    }
}
