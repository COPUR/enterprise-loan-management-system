package com.bank.loanmanagement.loan.architecture;
...
public class ArchitectureTest {
    ...
    static void setUp() {
        importedClasses = new ClassFileImporter()
            ...
            .importPackages("com.bank.loanmanagement.loan", "com.banking.loans");
    }
    ...
    class DomainDrivenDesignTests {
        ...
        void aggregatesMustExtendAggregateRoot() {
            ArchRule rule = classes()
                ...
                .should().beAssignableTo("com.bank.loanmanagement.loan.domain.shared.AggregateRoot")
        ...
        void domainEventsMustFollowNamingConvention() {
            ArchRule rule = classes()
                ...
                .and().implement("com.bank.loanmanagement.loan.domain.shared.DomainEvent")
    ...
    class PackageDependencyTests {
        ...
        void noPackageCyclicDependencies() {
            ArchRule rule = slices()
                .matching("com.bank.loanmanagement.loan.(*)..")
