...
import com.bank.loanmanagement.loan.domain.loan.LoanRepository;
...
public class PaymentProcessingService {
    ...
    @Transactional
    public Payment createPayment(Loan loan, com.bank.loanmanagement.loan.domain.shared.Money amount, PaymentMethod paymentMethod, LocalDate paymentDate) {
    ...
    private Money convertToSharedkernelMoney(com.bank.loanmanagement.loan.domain.shared.Money legacyMoney) {
        if (legacyMoney == null) {
            return null;
        }
    ...
    private com.bank.loanmanagement.loan.domain.shared.Money convertToLegacyMoney(Money sharedkernelMoney) {
        if (sharedkernelMoney == null) {
            return null;
        }
        return com.bank.loanmanagement.loan.domain.shared.Money.of(
    ...
    private com.bank.loanmanagement.loan.domain.customer.CustomerId convertCustomerId(
        com.bank.loan.loan.domain.customer.CustomerId customerId) {
        if (customerId == null) {
            return null;
        }
        return new com.bank.loanmanagement.loan.domain.customer.CustomerId(customerId.getValue());
    }
}