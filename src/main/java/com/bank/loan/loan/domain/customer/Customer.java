...
import com.bank.loan.sharedkernel.domain.AggregateRoot;
import com.bank.loan.sharedkernel.domain.Money;
import com.bank.customer.domain.event.CustomerCreatedEvent;
import com.bank.customer.domain.event.CreditReservedEvent;
import com.bank.customer.domain.event.CreditReleasedEvent;
import com.bank.customer.domain.event.CustomerActivatedEvent;
import com.bank.customer.domain.event.CustomerSuspendedEvent;
import com.bank.loan.sharedkernel.domain.valueobjects.CreditScore;
import com.bank.loan.loan.domain.customer.PersonalName;
import com.bank.loan.loan.domain.customer.EmailAddress;
import com.bank.loan.loan.domain.customer.PhoneNumber;
import com.bank.loan.loan.domain.customer.CreditLimit;
