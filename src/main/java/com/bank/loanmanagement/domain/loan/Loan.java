...
import com.bank.loanmanagement.domain.loan.event.LoanApplicationSubmittedEvent;
import com.bank.loanmanagement.domain.loan.event.LoanApprovedEvent;
import com.bank.loanmanagement.domain.loan.event.LoanRejectedEvent;
import com.bank.loanmanagement.domain.loan.event.LoanDisbursedEvent;
import com.bank.loanmanagement.domain.loan.event.LoanPaymentMadeEvent;
import com.bank.loanmanagement.domain.loan.event.LoanPaidOffEvent;
import com.bank.loanmanagement.domain.loan.event.LoanDefaultedEvent;
import com.bank.loanmanagement.domain.loan.event.LoanRestructuredEvent;
