...
import com.bank.loanmanagement.ai.domain.model.AnalysisStatus;
...
public interface SpringDataLoanAnalysisRequestRepository extends JpaRepository<LoanAnalysisRequestEntity, LoanAnalysisRequestId> {
    ...
    List<LoanAnalysisRequestEntity> findByEmploymentTypeAndLoanPurpose(
        @Param("employmentType") com.bank.loanmanagement.ai.domain.model.EmploymentType employmentType,
        @Param("loanPurpose") com.bank.loanmanagement.ai.domain.model.LoanPurpose loanPurpose
    );
}