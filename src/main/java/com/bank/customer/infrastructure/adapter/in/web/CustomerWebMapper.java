package com.bank.customer.infrastructure.adapter.in.web;

import com.bank.loan.loan.domain.customer.Customer;
import com.bank.loan.loan.domain.customer.CustomerId;
import com.bank.customer.domain.port.in.CreateCustomerCommand;
import com.bank.customer.domain.port.in.UpdateCustomerCommand;
import com.bank.customer.infrastructure.adapter.in.web.dto.CreateCustomerRequest;
import com.bank.customer.infrastructure.adapter.in.web.dto.CustomerResponse;
import com.bank.customer.infrastructure.adapter.in.web.dto.UpdateCustomerRequest;
