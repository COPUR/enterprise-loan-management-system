...
import com.bank.customer.application.service.CustomerAlreadyExistsException;
import com.bank.customer.application.service.CustomerNotFoundException;
import com.bank.loan.loan.domain.customer.Customer;
import com.bank.loan.loan.domain.customer.CustomerId;
import com.bank.loan.loan.domain.customer.InsufficientCreditException;
import com.bank.customer.domain.port.in.*;
import com.bank.customer.infrastructure.adapter.in.web.dto.*;
