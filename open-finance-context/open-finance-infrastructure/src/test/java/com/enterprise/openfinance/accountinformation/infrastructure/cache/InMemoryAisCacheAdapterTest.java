package com.enterprise.openfinance.accountinformation.infrastructure.cache;
...
import com.enterprise.openfinance.accountinformation.infrastructure.config.AccountInformationCacheProperties;
...
class InMemoryAisCacheAdapterTest {
    ...
    private static AccountInformationCacheProperties properties(int maxEntries) {
        AccountInformationCacheProperties properties = new AccountInformationCacheProperties();
