...
import com.enterprise.openfinance.uc13.domain.exception.PayRequestFinalizedException;
import com.enterprise.openfinance.uc13.domain.exception.ResourceNotFoundException;
import com.enterprise.openfinance.uc13.infrastructure.rest.dto.PayRequestErrorResponse;
...
class PayRequestExceptionHandlerTest {
    ...
    void shouldMapNotFound() {
        ...
        request.addHeader("X-FAPI-Interaction-ID", "ix-uc13-err-1");
    ...
    void shouldMapFinalizedConflict() {
        MockHttpServletRequest request = new MockHttpServletRequest();
        request.addHeader("X-FAPI-Interaction-ID", "ix-uc13-err-2");
    ...
    void shouldMapInvalidRequest() {
        MockHttpServletRequest request = new MockHttpServletRequest();
        request.addHeader("X-FAPI-Interaction-ID", "ix-uc13-err-3");
    ...
    void shouldMapUnexpectedError() {
        MockHttpServletRequest request = new MockHttpServletRequest();
        request.addHeader("X-FAPI-Interaction-ID", "ix-uc13-err-4");
