...
class InMemoryCorporateCacheAdapterTest {
    ...
    private static CorporateTreasuryCacheProperties properties(int maxEntries) {
        CorporateTreasuryCacheProperties properties = new CorporateTreasuryCacheProperties();
