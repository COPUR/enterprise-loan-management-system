package com.enterprise.openfinance.uc06.infrastructure.cache;
...
import com.enterprise.openfinance.uc06.infrastructure.config.Uc06IdempotencyProperties;
...
class InMemoryPaymentIdempotencyAdapterTest {
    ...
    private static Uc06IdempotencyProperties properties(int maxEntries) {
        Uc06IdempotencyProperties properties = new Uc06IdempotencyProperties();
