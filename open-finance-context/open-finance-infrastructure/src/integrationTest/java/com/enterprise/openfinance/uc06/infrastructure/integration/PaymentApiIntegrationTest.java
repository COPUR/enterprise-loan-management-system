package com.enterprise.openfinance.uc06.infrastructure.integration;
...
class PaymentApiIntegrationTest {
    ...
    private MockHttpServletRequestBuilder withBaseHeaders(MockHttpServletRequestBuilder builder) {
        return builder
                ...
                .header("X-FAPI-Interaction-ID", "ix-uc06-integration")
    ...
    @ComponentScan(basePackages = {
            "com.enterprise.openfinance.uc06.application",
            "com.enterprise.openfinance.uc06.infrastructure"
    })
