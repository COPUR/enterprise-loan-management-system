package com.enterprise.openfinance.uc15.infrastructure.integration;
...
class AtmDataApiIntegrationTest {
    ...
    void shouldListAtmsAndSupportEtagRevalidation() throws Exception {
        MvcResult first = mockMvc.perform(get("/open-finance/v1/atms")
                        .header("X-FAPI-Interaction-ID", "ix-uc15-int-1")
    ...
    void shouldFilterByLocationAndRejectInvalidRequests() throws Exception {
        mockMvc.perform(get("/open-finance/v1/atms")
                        .header("X-FAPI-Interaction-ID", "ix-uc15-int-2")
                        .param("lat", "25.2048")
                        .param("long", "55.2708")
                        .param("radius", "2")
                        .accept("application/json"))
        ...
        mockMvc.perform(get("/open-finance/v1/atms")
                        .header("X-FAPI-Interaction-ID", "ix-uc15-int-3")
        ...
        mockMvc.perform(get("/open-finance/v1/atms")
                        .header("X-FAPI-Interaction-ID", "ix-uc15-int-4")
                        .param("lat", "95")
                        .param("long", "55")
                        .accept("application/json"))
                .andExpect(status().isBadRequest())
