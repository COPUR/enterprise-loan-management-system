package com.enterprise.openfinance.accountinformation.infrastructure.integration;
...
class AccountInformationApiIntegrationTest {
    ...
    private static MockHttpServletRequestBuilder withHeaders(MockHttpServletRequestBuilder builder, String consentId) {
        return builder
                ...
                .header("X-FAPI-Interaction-ID", "ix-account-information-integration")
    ...
    @ComponentScan(basePackages = {
            "com.enterprise.openfinance.accountinformation.application",
            "com.enterprise.openfinance.accountinformation.infrastructure"
    })
