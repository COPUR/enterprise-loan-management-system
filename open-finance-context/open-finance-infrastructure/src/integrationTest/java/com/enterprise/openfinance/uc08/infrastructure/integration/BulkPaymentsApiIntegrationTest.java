package com.enterprise.openfinance.uc08.infrastructure.integration;
...
class BulkPaymentsApiIntegrationTest {
    ...
    private static MockHttpServletRequestBuilder withHeaders(MockHttpServletRequestBuilder builder) {
        return builder
                ...
                .header("X-FAPI-Interaction-ID", "ix-uc08-integration")
    ...
    @ComponentScan(basePackages = {
            "com.enterprise.openfinance.uc08.application",
            "com.enterprise.openfinance.uc08.infrastructure"
    })
