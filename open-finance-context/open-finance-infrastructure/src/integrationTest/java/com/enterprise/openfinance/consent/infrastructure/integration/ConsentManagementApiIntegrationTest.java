package com.enterprise.openfinance.consent.infrastructure.integration;
...
class ConsentManagementApiIntegrationTest {
    ...
    private static MockHttpServletRequestBuilder withSecurityHeaders(MockHttpServletRequestBuilder builder) {
        return builder
                .header("Authorization", "DPoP consent-integration-test-token")
    ...
    @ComponentScan(basePackages = {
            "com.enterprise.openfinance.consent.application",
            "com.enterprise.openfinance.consent.infrastructure"
    })
