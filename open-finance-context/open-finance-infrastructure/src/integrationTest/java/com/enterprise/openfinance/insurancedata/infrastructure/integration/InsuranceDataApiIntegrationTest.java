package com.enterprise.openfinance.insurancedata.infrastructure.integration;
...
class InsuranceDataApiIntegrationTest {
    ...
    void shouldRejectInvalidSecurityHeadersAndConsentViolations() throws Exception {
        mockMvc.perform(get("/open-insurance/v1/motor-insurance-policies")
                        ...
                        .header("X-FAPI-Interaction-ID", "ix-insurance-data-integration")
                        .header("X-Consent-ID", "CONS-INS-001")
    ...
    @ComponentScan(basePackages = {
            "com.enterprise.openfinance.insurancedata.application",
            "com.enterprise.openfinance.insurancedata.infrastructure"
    })
