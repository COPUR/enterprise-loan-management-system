package com.enterprise.openfinance.uc06.infrastructure.rest;

import com.enterprise.openfinance.uc06.infrastructure.rest.dto.PaymentErrorResponse;
...
@RestControllerAdvice(basePackages = "com.enterprise.openfinance.uc06.infrastructure.rest")
