package com.enterprise.openfinance.uc11.infrastructure.cache;
...
import com.enterprise.openfinance.uc11.infrastructure.config.Uc11CacheProperties;
...
public class InMemoryFxCacheAdapter implements FxCachePort {
    ...
    @Autowired
    public InMemoryFxCacheAdapter(Uc11CacheProperties properties) {
