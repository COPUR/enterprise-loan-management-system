package com.enterprise.openfinance.uc13.infrastructure.functional;
...
class PayRequestUatTest {
    ...
    void shouldRejectInvalidAuthorization() {
        given().baseUri("http://localhost").port(port)
                ...
                .header("DPoP", "proof")
                .header("X-FAPI-Interaction-ID", "ix-uc13-uat-err")
    ...
    private RequestSpecification request() {
        return given().baseUri("http://localhost").port(port)
                ...
                .header("DPoP", "proof")
                .header("X-FAPI-Interaction-ID", "ix-uc13-uat")
                .header("x-fapi-financial-id", "TPP-001");
    }
    ...
    @ComponentScan(basePackages = {
            "com.enterprise.openfinance.uc13.application",
            "com.enterprise.openfinance.uc13.infrastructure"
    })
