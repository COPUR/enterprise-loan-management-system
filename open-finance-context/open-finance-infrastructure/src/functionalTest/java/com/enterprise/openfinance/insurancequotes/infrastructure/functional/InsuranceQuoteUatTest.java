package com.enterprise.openfinance.insurancequotes.infrastructure.functional;
...
class InsuranceQuoteUatTest {
    ...
    void shouldCompleteQuoteToPolicyJourney() {
        ...
        request()
                .header("X-Idempotency-Key", "IDEMP-UAT-INSURANCE-QUOTES-1")
                .contentType("application/json")
                .body("""
                        {
                          "Data": {
    ...
    void shouldRejectQuoteParameterManipulation() {
        ...
        request()
                .header("X-Idempotency-Key", "IDEMP-UAT-INSURANCE-QUOTES-2")
                .contentType("application/json")
                .body("""
                        {
                          "Data": {
    ...
    void shouldRejectUnsupportedAuthorizationHeader() {
        given().baseUri("http://localhost").port(port)
                ...
                .header("X-FAPI-Interaction-ID", "ix-insurance-quotes-functional")
