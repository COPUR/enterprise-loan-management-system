package com.enterprise.openfinance.atmdata.infrastructure.functional;
...
class AtmDataUatTest {
    ...
    void shouldRejectInvalidAuthorization() {
        given().baseUri("http://localhost").port(port)
                ...
                .header("X-FAPI-Interaction-ID", "ix-atm-data-uat-err")
    ...
    private RequestSpecification request() {
        return given().baseUri("http://localhost").port(port)
                .accept("application/json")
                .header("X-FAPI-Interaction-ID", "ix-atm-data-uat")
