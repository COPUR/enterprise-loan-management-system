...
/**
 * Domain event representing the approval of an Islamic Finance Product
 * 
 ...
 */
@Value
public class ProductApprovedEvent implements DomainEvent {
    ...
    public ProductApprovedEvent(IslamicFinanceProductId productId, CustomerId customerId,
                               IslamicFinanceType financeType, String approverId,
                               String jurisdiction) {
