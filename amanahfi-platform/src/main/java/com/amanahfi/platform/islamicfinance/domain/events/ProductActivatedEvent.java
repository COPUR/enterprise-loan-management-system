...
/**
 * Domain event representing the activation of an Islamic Finance Product
 * 
...
public class ProductActivatedEvent implements DomainEvent {
    ...
    public ProductActivatedEvent(IslamicFinanceProductId productId, CustomerId customerId,
                                IslamicFinanceType financeType, String jurisdiction) {
